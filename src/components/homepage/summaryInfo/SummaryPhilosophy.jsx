function SummaryPhilosophy({title,description,borderColor, textColorTitle}){
    return(
        <article className={`flex flex-col justify-center items-center p-6 border-3 transform transition duration-300 hover:scale-105 ${borderColor} text-primary gap-6`}>
